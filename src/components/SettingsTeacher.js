    ...
    try {
      ...
      if (userData && docId) {
        setUserDetails({
          ...
          instructionalLevel: userData.level || "",
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      await updateDoc(userRef, {
        ...
        level: userDetails.instructionalLevel,
  ...
  return (
    <div>
              ...
              <>
                ...
                >
                  <p style={{ 
                    ...
                    <strong>Note:</strong> Only Contact Number, Instructional Level, and Section fields are editable. 
                    Your Full Name, School ID, and Email Address are managed by the administrator for security purposes.
                  </p>
                </div>
                    ...
                    <div className="col-md-6 mb-4">
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onBlur={(e) => {
                            e.target.style.borderColor = "rgba(255, 84, 154, 0.3)";
      ...
      <style jsx>{`
        ...
        .tab-button:hover {
          background: linear-gradient(135deg, rgba(255, 84, 154, 0.1), rgba(194, 24, 91, 0.05)) !important;
          border-color: rgba(255, 84, 154, 0.2) !important;
        }
